      ...
      <div className="space-y-6">
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#7d51ff] via-[#9d71ff] to-[#b591ff] p-8 text-white shadow-2xl">
          ...
          <div className="relative">
            <h1 className="text-4xl font-bold tracking-tight mb-2">Move-in/Move-out Requests</h1>
        ...
        <Card className="border-destructive/50 bg-destructive/5">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-lg font-medium text-destructive mb-2">Failed to load requests</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-900">{moveRequests.length}</p>
              </div>
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-green-600">Move-in Requests</p>
                <p className="text-2xl font-bold text-green-900">
                  {moveRequests.filter(r => r.shift_type.toLowerCase() === 'move-in').length}
                </p>
              </div>
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-purple-600">Move-out Requests</p>
                <p className="text-2xl font-bold text-purple-900">
                  {moveRequests.filter(r => r.shift_type.toLowerCase() === 'move-out').length}
                </p>
              </div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-medium mb-2">No move requests found</h3>
              <p className="text-muted-foreground mb-4">
            ...
            <div className="space-y-4">
              {moveRequests.map((request) => (
                <Card key={request.user_id} className="hover:shadow-md transition-shadow">
                  <CardContent className="p-6">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex-shrink-0">
                        <div className="bg-gradient-to-br from-[#7d51ff] to-[#9d71ff] text-white rounded-xl p-4 min-w-[80px] text-center">
                          <div className="text-2xl font-bold">{request.unit_number}</div>
                      ...
                      <div className="flex-1 flex items-center gap-6 text-sm text-muted-foreground">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="font-medium">{formatTime(request.time)}</span>
                        </div>
                      </div>
